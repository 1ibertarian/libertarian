...
//  以下为MOG可视化编辑器生成部分
//=============================================================================
	Moghunter.scItem_ItemWindowWidth =370;
	Moghunter.scItem_ItemWindowHeight =397;
	Moghunter.scItem_ItemWindowX =6;
	Moghunter.scItem_ItemWindowY =109;
	...
	Moghunter.scItem_ItemWindow_fontsize =22;
	Moghunter.scItem_ItemWindow_col =1;
	Moghunter.scItem_HelpWindowX =0;
	Moghunter.scItem_HelpWindowY =526;
	Moghunter.scItem_Com1_X =270;
	Moghunter.scItem_Com1_Y =60;
	Moghunter.scItem_Com2_X =411;
	Moghunter.scItem_Com2_Y =60;
	Moghunter.scItem_Com3_X =555;
	Moghunter.scItem_Com3_Y =59;
	Moghunter.scItem_Com4_X =690;
	Moghunter.scItem_Com4_Y =60;
	Moghunter.scItem_ActorWinX =604;
	Moghunter.scItem_ActorWinY =255;
	...
	Moghunter.scItem_ActorParFontSize =22;
	Moghunter.scItem_ActorFaceX =90;
	Moghunter.scItem_ActorFaceY =-68;
	Moghunter.scItem_ActorStatesX =23;
	Moghunter.scItem_ActorStatesY =14;
	Moghunter.scItem_ActorParX =0;
	Moghunter.scItem_ActorParY =0;
	Moghunter.scItem_ActorPar_hor =90;
	Moghunter.scItem_ActorPar_ver =33;
	Moghunter.scItem_Actor_NameX =66;
	Moghunter.scItem_Actor_NameY =34;
	Moghunter.scItem_PartyX =10;
	Moghunter.scItem_PartyY =240;
	Moghunter.scItem_PartyX_hide =-233;
	Moghunter.scItem_PartyY_hide =252;
	Moghunter.scItem_PartyX_last =0;
	Moghunter.scItem_PartyY_last =140;
	Moghunter.scItem_PartyX_next =0;
	Moghunter.scItem_PartyY_next =340;
	Moghunter.scItem_PartyFontSize =20;
	Moghunter.scItem_PartyNameX =20;
	Moghunter.scItem_PartyNameY =40;
	Moghunter.scItem_PartyHPNumberX =20;
	Moghunter.scItem_PartyHPNumberY =3;
	Moghunter.scItem_PartyMPNumberX =120;
	Moghunter.scItem_PartyMPNumberY =3;
	Moghunter.scItem_PartyHPMeterX =16;
	Moghunter.scItem_PartyHPMeterY =30;
	Moghunter.scItem_PartyMPMeterX =113;
	Moghunter.scItem_PartyMPMeterY =30;
	Moghunter.scItem_PartyStatusX =165;
	Moghunter.scItem_PartyStatusY =39;
	Moghunter.menu_item_face_list_length = 60;
	Moghunter.menu_item_face_list = {};
...
//=============================================================================
	Moghunter.menu_item_face_list_length = 60;
	Moghunter.menu_item_face_list = {};
	Moghunter.menu_item_face_list[1] = '物品界面-角色头像_1';
	Moghunter.menu_item_face_list[2] = '物品界面-角色头像_2';
	Moghunter.menu_item_face_list[3] = '物品界面-角色头像_3';
	Moghunter.menu_item_face_list[4] = '物品界面-角色头像_4';
	Moghunter.menu_item_face_list[5] = '物品界面-角色头像_5';
	Moghunter.menu_item_face_list[6] = '物品界面-角色头像_6';
	Moghunter.menu_item_face_list[12] = '物品界面-角色头像_12';	}
//=============================================================================
// ** ImageManager
//=============================================================================
